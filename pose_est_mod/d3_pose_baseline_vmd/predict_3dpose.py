...
tf.app.flags.DEFINE_float("dropout", 0.5, "Dropout keep probability. 1 means no dropout")#1
tf.app.flags.DEFINE_integer("batch_size", 64, "Batch size to use during training")
tf.app.flags.DEFINE_integer("epochs", 200, "How many epochs we should train for")
tf.app.flags.DEFINE_boolean("camera_frame", True, "Convert 3d poses to camera coordinates")#false
tf.app.flags.DEFINE_boolean("max_norm", True, "Apply maxnorm constraint to the weights")#false
tf.app.flags.DEFINE_boolean("batch_norm", True, "Use batch_normalization")#false

# Data loading
tf.app.flags.DEFINE_boolean("predict_14", False, "predict 14 joints")
tf.app.flags.DEFINE_boolean("use_sh", True, "Use 2d pose predictions from StackedHourglass")#false
tf.app.flags.DEFINE_string("action","All", "The action to train on. 'All' means all the actions")

# Architecture
tf.app.flags.DEFINE_integer("linear_size", 1024, "Size of each model layer.")
tf.app.flags.DEFINE_integer("num_layers", 2, "Number of layers in the model.")
tf.app.flags.DEFINE_boolean("residual", True, "Whether to add a residual connection every 2 layers")#false

# Evaluation
tf.app.flags.DEFINE_boolean("procrustes", False, "Apply procrustes analysis at test time")
tf.app.flags.DEFINE_boolean("evaluateActionWise",True, "The dataset to use either h36m or heva")#false

# Directories
base = abspath(dirname(__file__))
tf.app.flags.DEFINE_string("cameras_path",join(base,"data/h36m/cameras.h5"),"Directory to load camera parameters")
tf.app.flags.DEFINE_string("data_dir",   join(base,"data/h36m/"), "Data directory")
tf.app.flags.DEFINE_string("train_dir", join(base,"experiments"), "Training directory.")
...
tf.app.flags.DEFINE_integer("verbose", 1, "0:Error, 1:Warning, 2:INFO*(default), 3:debug")
